...
#         """Search registered tools based on a natural language query."""
#         try:
...
#                     if q in tool["name"].lower() or q in tool.get("description", "").lower():
...
#             raise HTTPException(status_code=500, detail=f"Failed to search tools: {e}")
